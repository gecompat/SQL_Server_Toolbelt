...
required=('Source/TVF_CalendarDifference.sql','Deployment/Deploy.sql','Deployment/Uninstall.sql','README.md','Documentation/TVF_CalendarDifference.md','Tests/Runtime/CalendarDifference.Contract.sql','module.yaml')
