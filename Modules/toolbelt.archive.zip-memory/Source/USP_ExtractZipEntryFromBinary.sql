...
EXEC toolbelt_archive.USP_ExtractZipEntryFromBinary
    ...
    SET @TotalEntries =
        CONVERT(int, CONVERT(varbinary(2), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @EocdStartPos + 10), 2))));
    SET @CentralDirectorySize =
        CONVERT(int, CONVERT(varbinary(4), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @EocdStartPos + 12), 4))));
    SET @CentralDirectoryOffset =
        CONVERT(int, CONVERT(varbinary(4), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @EocdStartPos + 16), 4))));
    SET @CommentLength =
        CONVERT(int, CONVERT(varbinary(2), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @EocdStartPos + 20), 2))));
    ...
    BEGIN
        ...
        SET @GpFlags =
            CONVERT(int, CONVERT(varbinary(2), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @CursorPos + 8), 2))));
        SET @Method =
            CONVERT(int, CONVERT(varbinary(2), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @CursorPos + 10), 2))));
        SET @Crc32 =
            CONVERT(int, CONVERT(varbinary(4), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @CursorPos + 16), 4))));
        SET @CompressedSize =
            CONVERT(int, CONVERT(varbinary(4), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @CursorPos + 20), 4))));
        SET @UncompressedSize =
            CONVERT(int, CONVERT(varbinary(4), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @CursorPos + 24), 4))));
        SET @NameLength =
            CONVERT(int, CONVERT(varbinary(2), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @CursorPos + 28), 2))));
        SET @ExtraLength =
            CONVERT(int, CONVERT(varbinary(2), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @CursorPos + 30), 2))));
        SET @CommentLen =
            CONVERT(int, CONVERT(varbinary(2), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @CursorPos + 32), 2))));
        SET @LocalOffset =
            CONVERT(int, CONVERT(varbinary(4), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @CursorPos + 42), 4))));
    ...
    SET @LocalFlags =
        CONVERT(int, CONVERT(varbinary(2), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @LocalHeaderPos + 6), 2))));
    SET @LocalMethod =
        CONVERT(int, CONVERT(varbinary(2), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @LocalHeaderPos + 8), 2))));
    SET @LocalCrc =
        CONVERT(int, CONVERT(varbinary(4), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @LocalHeaderPos + 14), 4))));
    SET @LocalCompressed =
        CONVERT(int, CONVERT(varbinary(4), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @LocalHeaderPos + 18), 4))));
    SET @LocalUncompressed =
        CONVERT(int, CONVERT(varbinary(4), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @LocalHeaderPos + 22), 4))));
    SET @LocalNameLen =
        CONVERT(int, CONVERT(varbinary(2), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @LocalHeaderPos + 26), 2))));
    SET @LocalExtraLen =
        CONVERT(int, CONVERT(varbinary(2), REVERSE(SUBSTRING(@ZipArchive, CONVERT(int, @LocalHeaderPos + 28), 2))));
