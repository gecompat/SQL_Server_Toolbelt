...
IF IS_SRVROLEMEMBER(N'sysadmin') <> 1
    THROW 51340, N'Das Trust-Opt-in für die CLR-ZIP-Assembly erfordert sysadmin.', 1;
...
IF NOT EXISTS
   (
    ...
    THROW 51341, N'CLR ist auf dieser Instanz nicht aktiviert. Das Modul ändert keine Instanzoption.', 1;
...
IF @AssemblyHash IS NULL OR DATALENGTH(@AssemblyHash) <> 64
    THROW 51343, N'AssemblyHash muss ein SHA2-512-Hexliteral mit genau 64 Bytes sein.', 1;
IF NULLIF(@AssemblyDescription, N'') IS NULL
    THROW 51344, N'AssemblyDescription darf nicht leer sein.', 1;
