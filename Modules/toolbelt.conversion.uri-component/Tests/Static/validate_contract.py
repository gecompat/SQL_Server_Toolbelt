...
required=('Source/TVF_UriComponentEncode.sql','Source/TVF_UriComponentDecode.sql','Source/SVF_UriComponentEncode.sql','Source/SVF_UriComponentDecode.sql','Deployment/Deploy.sql','Deployment/Uninstall.sql','README.md','module.yaml','Tests/Runtime/UriComponent.Contract.sql')
