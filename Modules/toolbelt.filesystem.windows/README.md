...
Die Laufzeitvalidierung ist noch nicht ausgeführt. Vor produktiver Verwendung ist der manuelle Windows-Test aus `Tests/WINDOWS_FILESYSTEM_CONTRACT_TEST_MATRIX.md` verpflichtend.
