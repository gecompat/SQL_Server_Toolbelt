...
Erzeugt ein Directory unter einem Root-Alias. Rückgabe: RootAlias, RelativePath, State.

## Parameter

@RootAlias, @RelativePath, @ExecutionIdentity, @ResultTable, @KeepData, @Debug, @Hilfe
