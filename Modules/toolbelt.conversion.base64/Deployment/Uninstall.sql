...
-- ============================================================================
-- Zweck:     Kontrollierte Deinstallation von toolbelt.conversion.base64
-- Modus:     SQLCMD
...
BEGIN
    THROW 51045, N'Die SQLCMD-Variable ConfirmNoExternalConsumers muss 0 oder 1 sein.', 1;
END;
...
BEGIN
    PRINT N'toolbelt.conversion.base64 ist nicht als installiert registriert; keine Änderung erforderlich.';
    RETURN;
END;
...
BEGIN
    THROW 51043, N'Der registrierte Deployment-Modus fehlt oder ist ungültig.', 1;
END;

IF @DeploymentMode = N'central' AND @ConfirmNoExternalConsumers <> 1
BEGIN
    THROW 51045, N'Bei zentraler Installation ist ConfirmNoExternalConsumers=1 als ausdrückliche Betreiberbestätigung erforderlich.', 1;
END;
...
BEGIN
    ...
    THROW 51046, @DependencyMessage, 1;
END;
...
BEGIN TRY
    ...
    BEGIN
        THROW 51047, N'Der installierte Modulstand hat sich seit dem Uninstall-Preflight verändert.', 1;
    END;
    ...
    BEGIN
        ...
        BEGIN
            ...
            IF @DropSql IS NULL
            BEGIN
                THROW 51043, N'Ein Release-Objekt besitzt einen nicht unterstützten lokal veränderten Objekttyp.', 1;
            END;
