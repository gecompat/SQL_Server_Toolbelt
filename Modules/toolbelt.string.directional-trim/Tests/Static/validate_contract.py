...
required=('Source/TVF_TrimDirectionalNvarchar.sql','Source/TVF_TrimDirectionalVarchar.sql','Deployment/Deploy.sql','Deployment/Uninstall.sql','README.md','module.yaml','Tests/Runtime/DirectionalTrim.Contract.sql','Tests/Runtime/Collation.Contract.sql','Tests/Runtime/Lifecycle.Contract.sql','Tests/Runtime/Central.Contract.sql')
