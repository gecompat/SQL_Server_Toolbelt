...
(
    ...
    WHERE d.referenced_id IN
      (OBJECT_ID(N'toolbelt_core.WorkItem'),OBJECT_ID(N'toolbelt_core.WorkQueueScheduler'),OBJECT_ID(N'toolbelt_core.WorkQueueBarrierBlocker'),OBJECT_ID(N'toolbelt_core.VW_WorkQueue'),OBJECT_ID(N'toolbelt_core.VW_WorkQueueBarrierBlockers'),OBJECT_ID(N'toolbelt_core.USP_EnqueueWork'),OBJECT_ID(N'toolbelt_core.USP_EnqueueWorkWithPolicy'),OBJECT_ID(N'toolbelt_core.USP_EnqueueBarrierWork'),OBJECT_ID(N'toolbelt_core.USP_ClaimWork'),OBJECT_ID(N'toolbelt_core.USP_RenewWorkLease'),OBJECT_ID(N'toolbelt_core.USP_RecoverExpiredWork'),OBJECT_ID(N'toolbelt_core.USP_CompleteWork'),OBJECT_ID(N'toolbelt_core.USP_FailWork'),OBJECT_ID(N'toolbelt_core.USP_ScheduleWorkRetry'),OBJECT_ID(N'toolbelt_core.USP_RequeueDeadLetter'),OBJECT_ID(N'toolbelt_core.USP_GetWorkStatus'))
      ...
      (
          ...
          WHERE module_object.class=1 AND module_object.major_id=d.referencing_id AND module_object.minor_id=0
...
BEGIN TRANSACTION;
DROP PROCEDURE IF EXISTS toolbelt_core.USP_RequeueDeadLetter;
DROP PROCEDURE IF EXISTS toolbelt_core.USP_ScheduleWorkRetry;
...
DROP PROCEDURE IF EXISTS toolbelt_core.USP_EnqueueBarrierWork;
DROP PROCEDURE IF EXISTS toolbelt_core.USP_EnqueueWorkWithPolicy;
DROP PROCEDURE IF EXISTS toolbelt_core.USP_EnqueueWork;
DROP VIEW IF EXISTS toolbelt_core.VW_WorkQueueBarrierBlockers;
DROP VIEW IF EXISTS toolbelt_core.VW_WorkQueue;
DROP TABLE IF EXISTS toolbelt_core.WorkQueueBarrierBlocker;
DROP TABLE IF EXISTS toolbelt_core.WorkQueueScheduler;
