...
IF OBJECT_ID(N'toolbelt_core.WorkItem',N'U') IS NULL OR OBJECT_ID(N'toolbelt_core.VW_WorkQueue',N'V') IS NULL
 ...
 OR OBJECT_ID(N'toolbelt_core.USP_GetWorkStatus',N'P') IS NULL OR OBJECT_ID(N'toolbelt_core.USP_EnqueueWorkWithPolicy',N'P') IS NULL
 OR OBJECT_ID(N'toolbelt_core.USP_EnqueueBarrierWork',N'P') IS NULL OR OBJECT_ID(N'toolbelt_core.USP_ScheduleWorkRetry',N'P') IS NULL OR OBJECT_ID(N'toolbelt_core.USP_RequeueDeadLetter',N'P') IS NULL
 OR OBJECT_ID(N'toolbelt_core.VW_WorkQueueBarrierBlockers',N'V') IS NULL THROW 52930,N'Der Work-Queue-Objektbestand ist unvollständig.',1;
