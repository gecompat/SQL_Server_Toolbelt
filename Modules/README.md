...
**21 Module sind implementiert. 20 sind `partially validated`, 1 ist
...
| `toolbelt.filesystem.windows` | Windows Filesystem | `1.0.0` | `toolbelt_filesystem` | `implemented` | `not executed` | `unreleased` | 2019, 2022, 2025 |
