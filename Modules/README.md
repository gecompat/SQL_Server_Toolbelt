...
**14 Module sind implementiert; ihr Validierungsstand wird getrennt aus den Manifesten abgeleitet.**
...
| `toolbelt.json.path-exists` | JSON Path Exists | `1.0.0` | `toolbelt_json` | `implemented` | `not executed` | `unreleased` | 2019, 2022, 2025 |
