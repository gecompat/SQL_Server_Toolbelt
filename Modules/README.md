...
**Drei Module sind implementiert; ihr Validierungsstand wird getrennt aus den Manifesten abgeleitet.**
...
| `toolbelt.core.generate-series` | Portable Integer Series | `1.0.0` | `toolbelt_core` | `implemented` | `not executed` | `unreleased` | 2019, 2022, 2025 |
