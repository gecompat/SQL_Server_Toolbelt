...
[![Status: 5 Module implementiert – 4 teilweise validiert](https://img.shields.io/badge/Status-5%20Module%20implementiert%20%7C%204%20teilweise%20validiert-yellow)](./Modules/README.md)
...
Separatorzeichen. Runtime-Evidenz ist noch `not executed`; die breitere
Quote-/Escape-Ausbaustufe bleibt separat in `TC-2026-032`.
