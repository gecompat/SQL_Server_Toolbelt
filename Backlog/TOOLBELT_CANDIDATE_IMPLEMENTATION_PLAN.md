...
| `W6` | `W6a/W6b implemented`; Runtime `validated`; `W6c approved` | Queue, Retry, Lease, priorisierte Barriers und Cancellation | `015`, `021`, `020`, `048`, `018` | W6a und W6b am 2026-08-30, W6c am 2026-09-10 ausdrücklich freigegeben; Einzelvertrag und Freigabe für W6d | `W6a` und `W6b` sind implementiert und auf Windows/Linux 2019/2022/2025 validiert. `W6c` erweitert die Queue gemeinsam um Retry/Dead Letter/Idempotenz und priorisierte Gruppen-Barriers; `W6d` kooperative Cancellation bleibt offen. |
...
| `TC-2026-048` | `toolbelt.core.work-queue` (W6c) | `USP_EnqueueBarrierWork`, `VW_WorkQueueBarrierBlockers` | Am 2026-09-10 freigegeben: Priorität `0..255`, Gruppe pro Auftrag, exakter Claim-Snapshot und parallel laufende gleichpriorisierte Drain-Barriers. |
