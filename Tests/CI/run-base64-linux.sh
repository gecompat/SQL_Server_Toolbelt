...
container_name="tbx-base64-${GITHUB_RUN_ID:-local}"
...
deployment_directory="/workspace/Modules/toolbelt.conversion.base64/Deployment"
runtime_directory="/workspace/Modules/toolbelt.conversion.base64/Tests/Runtime"
local_database="tbx_base64_local"
...
consumer_database="tbx_base64_consumer"
...
run_query "${existing_schema_database}" \
    "IF SCHEMA_ID(N'toolbelt_conversion') IS NULL THROW 52341, N'Ein vorbestehendes unmarkiertes Schema wurde gelöscht.', 1;"

collision_database="tbx_base64_collision"
...
echo "Base64 SQL Server ${sql_version} (Compatibility ${compatibility_levels}): erfolgreich"
