...
deployment_directory="/workspace/Modules/toolbelt.validation.semantic-version/Deployment"
runtime_directory="/workspace/Modules/toolbelt.validation.semantic-version/Tests/Runtime"
local_database="tbx_semantic_version_local"
...
run_query "${existing_schema_database}" \
    "IF SCHEMA_ID(N'toolbelt_validation') IS NULL THROW 52741, N'Ein vorbestehendes unmarkiertes Schema wurde gelöscht.', 1;"

collision_database="tbx_semantic_version_collision"
